...
from config import BOT_TOKEN, ADMIN_IDS, RAILWAY_URL, CHANNEL_ID, MERCHANT_ID, API_SECRET, CRYPTOBOT_TOKEN, PLATEGA_SHOP_ID, PLATEGA_API_KEY
...
async def process_deposit_amount(message: Message, state: FSMContext):
    ...
    try:
        ...
        await message.answer(
            f"{emoji(EMOJI['key'], '❌')} Введите <b>число</b>!\n\nПример: <code>500</code>",
            parse_mode="HTML"
        )
