...
BUTTON_EMOJI = {
    ...
    "crypto": "5807499888245612254",
    "edit": "5872771279337033184",
}
...
def get_main_keyboard():
    return InlineKeyboardMarkup(inline_keyboard=[
        [
            InlineKeyboardButton(text=f"{tg_emoji(BUTTON_EMOJI['shop'], '🛍️')} Магазин", callback_data="menu_shop", icon_custom_emoji_id=BUTTON_EMOJI["shop"]),
            InlineKeyboardButton(text=f"{tg_emoji(BUTTON_EMOJI['profile'], '👤')} Профиль", callback_data="menu_profile", icon_custom_emoji_id=BUTTON_EMOJI["profile"])
        ],
        [
            InlineKeyboardButton(text=f"{tg_emoji(BUTTON_EMOJI['info'], 'ℹ️')} Информация", callback_data="menu_info", icon_custom_emoji_id=BUTTON_EMOJI["info"])
        ]
    ])
...
def get_profile_keyboard():
    return InlineKeyboardMarkup(inline_keyboard=[
        [
            InlineKeyboardButton(text=f"{tg_emoji(BUTTON_EMOJI['balance'], '💰')} Пополнить баланс", callback_data="profile_deposit", icon_custom_emoji_id=BUTTON_EMOJI["balance"]),
            InlineKeyboardButton(text=f"{tg_emoji(BUTTON_EMOJI['history'], '📋')} История заказов", callback_data="profile_history", icon_custom_emoji_id=BUTTON_EMOJI["history"])
        ],
        [
            InlineKeyboardButton(text=f"{tg_emoji(BUTTON_EMOJI['promocode'], '🎫')} Активировать промокод", callback_data="profile_activate_promocode", icon_custom_emoji_id=BUTTON_EMOJI["promocode"]),
            InlineKeyboardButton(text=f"{tg_emoji(BUTTON_EMOJI['referral'], '👥')} Реферальная система", callback_data="profile_referral", icon_custom_emoji_id=BUTTON_EMOJI["referral"])
        ],
        [
            InlineKeyboardButton(text=f"{tg_emoji(BUTTON_EMOJI['home'], '🏠')} Главное меню", callback_data="menu_main", icon_custom_emoji_id=BUTTON_EMOJI["home"])
        ]
    ])
...
def get_admin_keyboard():
    return InlineKeyboardMarkup(inline_keyboard=[
        [
            InlineKeyboardButton(text=f"{tg_emoji(BUTTON_EMOJI['add_product'], '➕')} Добавить товар", callback_data="admin_add_product", icon_custom_emoji_id=BUTTON_EMOJI["add_product"]),
            InlineKeyboardButton(text=f"{tg_emoji(BUTTON_EMOJI['add_keys'], '🔑')} Добавить ключи", callback_data="admin_add_keys", icon_custom_emoji_id=BUTTON_EMOJI["add_keys"])
        ],
        [
            InlineKeyboardButton(text=f"{tg_emoji(BUTTON_EMOJI['add_balance'], '💰')} Выдать баланс", callback_data="admin_add_balance", icon_custom_emoji_id=BUTTON_EMOJI["add_balance"]),
            InlineKeyboardButton(text=f"{tg_emoji(BUTTON_EMOJI['broadcast'], '📢')} Сделать рассылку", callback_data="admin_broadcast", icon_custom_emoji_id=BUTTON_EMOJI["broadcast"])
        ],
        [
            InlineKeyboardButton(text=f"{tg_emoji(BUTTON_EMOJI['promocode'], '🎫')} Создать промокод", callback_data="admin_create_promocode", icon_custom_emoji_id=BUTTON_EMOJI["promocode"]),
            InlineKeyboardButton(text=f"{tg_emoji(BUTTON_EMOJI['promocode'], '📋')} Список промокодов", callback_data="admin_list_promocodes", icon_custom_emoji_id=BUTTON_EMOJI["promocode"])
        ],
        [
            InlineKeyboardButton(text=f"{tg_emoji(BUTTON_EMOJI['referral'], '🎁')} Настройка рефералов", callback_data="admin_ref_config", icon_custom_emoji_id=BUTTON_EMOJI["referral"])
        ],
        [
            InlineKeyboardButton(text=f"{tg_emoji(BUTTON_EMOJI['crypto'], '💎')} Настройка криптооплаты", callback_data="admin_crypto_settings", icon_custom_emoji_id=BUTTON_EMOJI["crypto"])
        ],
        [
            InlineKeyboardButton(text=f"{tg_emoji(BUTTON_EMOJI['edit'], '✏️')} Редактировать сообщения", callback_data="admin_edit_messages", icon_custom_emoji_id=BUTTON_EMOJI["edit"])
        ],
        [
            InlineKeyboardButton(text=f"{tg_emoji(BUTTON_EMOJI['delete_product'], '📦')} Управление товарами", callback_data="admin_manage_products", icon_custom_emoji_id=BUTTON_EMOJI["delete_product"]),
            InlineKeyboardButton(text=f"{tg_emoji(BUTTON_EMOJI['delete_key'], '🔑')} Управление ключами", callback_data="admin_manage_keys", icon_custom_emoji_id=BUTTON_EMOJI["delete_key"])
        ],
        [
            InlineKeyboardButton(text=f"{tg_emoji(BUTTON_EMOJI['stats'], '📊')} Статистика", callback_data="admin_stats", icon_custom_emoji_id=BUTTON_EMOJI["stats"]),
            InlineKeyboardButton(text=f"{tg_emoji(BUTTON_EMOJI['home'], '🏠')} Главное меню", callback_data="menu_main", icon_custom_emoji_id=BUTTON_EMOJI["home"])
        ]
    ])
...
async def menu_shop(callback: CallbackQuery):
    ...
    if not products:
        await callback.message.edit_text(f"{tg_emoji(STICKERS['keys_count'], '📭')} <b>Товаров пока нет</b>", parse_mode="HTML", reply_markup=InlineKeyboardMarkup(inline_keyboard=[[InlineKeyboardButton(text=f"{tg_emoji(BUTTON_EMOJI['back'], '◀️')} Назад", callback_data="menu_main", icon_custom_emoji_id=BUTTON_EMOJI["back"])]]))
        await callback.answer()
        return
    
    kb = InlineKeyboardMarkup(inline_keyboard=[
        [InlineKeyboardButton(text=f"{tg_emoji(BUTTON_EMOJI['shop'], '🛍️')} {p['name']} | {p['price']}₽", callback_data=f"select_{p['id']}")]
        for p in products
    ] + [[InlineKeyboardButton(text=f"{tg_emoji(BUTTON_EMOJI['back'], '◀️')} Назад", callback_data="menu_main", icon_custom_emoji_id=BUTTON_EMOJI["back"])]])
    
    await callback.message.edit_text(f"{tg_emoji(STICKERS['shop_title'], '🛍️')} <b>Выберите интересующий вас товар</b>", parse_mode="HTML", reply_markup=kb)
    await callback.answer()
...
async def select_product(callback: CallbackQuery):
    ...
    if not product:
        await callback.answer(f"{tg_emoji(STICKERS['keys_count'], '❌')} Товар не найден")
        return
    
    balance = await get_balance(user_id)
    kb = InlineKeyboardMarkup(inline_keyboard=[
        [InlineKeyboardButton(text=f"{tg_emoji(BUTTON_EMOJI['balance'], '💰')} Оплатить с баланса", callback_data=f"pay_balance_{product_id}")],
        [InlineKeyboardButton(text=f"{tg_emoji(BUTTON_EMOJI['crypto'], '💎')} Оплатить криптовалютой", callback_data=f"pay_crypto_{product_id}")],
        [InlineKeyboardButton(text=f"{tg_emoji(BUTTON_EMOJI['back'], '◀️')} Назад", callback_data="menu_shop", icon_custom_emoji_id=BUTTON_EMOJI["back"])]
    ])
...
async def pay_balance(callback: CallbackQuery):
    ...
    if balance < product["price"]:
        await callback.answer(f"{tg_emoji(STICKERS['keys_count'], '❌')} Недостаточно средств! Нужно {product['price']} ₽")
        return
    
    key_row = await get_unused_key(product_id)
    if not key_row:
        await callback.answer(f"{tg_emoji(STICKERS['keys_count'], '❌')} Ключи закончились")
        return
        ...
        if referrer_id:
            ...
            if config and config["bonus_value"] > 0:
                if config["bonus_type"] == "rubles":
                    ...
                    await bot.send_message(referrer_id, f"{tg_emoji(STICKERS['product_selected'], '🎉')} Реферальный бонус! Вы получили {config['bonus_value']} ₽")
                    ...
                    await bot.send_message(referrer_id, f"{tg_emoji(STICKERS['product_selected'], '🎉')} Реферальный бонус! Вы получили {bonus_amount} ₽ ({config['bonus_value']}%)")
    ...
    await callback.message.edit_text(
        ...
        reply_markup=InlineKeyboardMarkup(inline_keyboard=[[InlineKeyboardButton(text=f"{tg_emoji(BUTTON_EMOJI['home'], '🏠')} В меню", callback_data="menu_main", icon_custom_emoji_id=BUTTON_EMOJI["home"])]])
    )
    await callback.answer(f"{tg_emoji(STICKERS['product_selected'], '🎉')} Покупка успешна!")
...
async def pay_crypto(callback: CallbackQuery):
    ...
    if mode == "auto":
        ...
        await callback.message.edit_text(
            f"{tg_emoji(BUTTON_EMOJI['crypto'], '💎')} <b>Оплата криптовалютой</b>\n\n"
            ...
            parse_mode="HTML",
            reply_markup=InlineKeyboardMarkup(inline_keyboard=[[InlineKeyboardButton(text=f"{tg_emoji(BUTTON_EMOJI['back'], '◀️')} Назад", callback_data="menu_shop", icon_custom_emoji_id=BUTTON_EMOJI["back"])]])
        )
    else:
        ...
        if manual_photo:
            ...
            await bot.send_photo(
                chat_id=user_id,
                photo=manual_photo,
                caption=f"{tg_emoji(BUTTON_EMOJI['crypto'], '💎')} <b>Оплата криптовалютой (ручной режим)</b>\n\n{manual_text}\n\n💰 Сумма: <code>{product['price']} ₽</code>\n\n📞 После оплаты напишите администратору @nikita1055",
                parse_mode="HTML",
                reply_markup=InlineKeyboardMarkup(inline_keyboard=[[InlineKeyboardButton(text=f"{tg_emoji(BUTTON_EMOJI['back'], '◀️')} Назад", callback_data="menu_shop", icon_custom_emoji_id=BUTTON_EMOJI["back"])]])
            )
        else:
            await callback.message.edit_text(
                f"{tg_emoji(BUTTON_EMOJI['crypto'], '💎')} <b>Оплата криптовалютой (ручной режим)</b>\n\n"
                f"{manual_text}\n\n"
...
async def profile_referral(callback: CallbackQuery):
    ...
    await callback.message.edit_text(text, parse_mode="HTML", reply_markup=InlineKeyboardMarkup(inline_keyboard=[[InlineKeyboardButton(text=f"{tg_emoji(BUTTON_EMOJI['back'], '◀️')} Назад", callback_data="menu_profile", icon_custom_emoji_id=BUTTON_EMOJI["back"])]]))
    await callback.answer()
...
async def profile_history(callback: CallbackQuery):
    ...
    if not purchases:
        await callback.message.edit_text(f"{tg_emoji(STICKERS['keys_count'], '📋')} <b>История заказов</b>\n\nУ вас пока нет покупок.", parse_mode="HTML", reply_markup=InlineKeyboardMarkup(inline_keyboard=[[InlineKeyboardButton(text=f"{tg_emoji(BUTTON_EMOJI['back'], '◀️')} Назад", callback_data="menu_profile", icon_custom_emoji_id=BUTTON_EMOJI["back"])]]))
        await callback.answer()
        return
    
    history_text = f"{tg_emoji(STICKERS['product_selected'], '🎉')} <b>История заказов</b>\n\n"
    for p in purchases[:10]:
        history_text += f"🆔 Заказ #{p['id']}\n{tg_emoji(STICKERS['magic'], '🎮')} Товар: {p['name']}\n💰 Цена: {p['price']} ₽\n📅 Дата: {p['created_at'].strftime('%d.%m.%Y %H:%M')}\n" + "─" * 15 + "\n"
    await callback.message.edit_text(history_text, parse_mode="HTML", reply_markup=InlineKeyboardMarkup(inline_keyboard=[[InlineKeyboardButton(text=f"{tg_emoji(BUTTON_EMOJI['back'], '◀️')} Назад", callback_data="menu_profile", icon_custom_emoji_id=BUTTON_EMOJI["back"])]]))
    await callback.answer()
...
async def profile_deposit(callback: CallbackQuery, state: FSMContext):
    ...
    await callback.message.edit_text(f"{tg_emoji(STICKERS['enter_amount'], '💰')} <b>Укажите сумму пополнения баланса</b>\n\nВведите сумму от 10 до 50000 ₽\n\nПример: <code>500</code>\n\nОтправьте число в этот чат", parse_mode="HTML", reply_markup=InlineKeyboardMarkup(inline_keyboard=[[InlineKeyboardButton(text=f"{tg_emoji(BUTTON_EMOJI['back'], '❌')} Отмена", callback_data="menu_profile", icon_custom_emoji_id=BUTTON_EMOJI["back"])]]))
    await callback.answer()
...
async def profile_activate_promocode(callback: CallbackQuery, state: FSMContext):
    ...
    await callback.message.edit_text(f"{tg_emoji(BUTTON_EMOJI['promocode'], '🎫')} <b>Активация промокода</b>\n\nВведите промокод:\n\nПример: <code>SUMMER2024</code>", parse_mode="HTML", reply_markup=InlineKeyboardMarkup(inline_keyboard=[[InlineKeyboardButton(text=f"{tg_emoji(BUTTON_EMOJI['back'], '❌')} Отмена", callback_data="menu_profile", icon_custom_emoji_id=BUTTON_EMOJI["back"])]]))
    await callback.answer()
...
async def admin_cmd(message: Message):
    if not is_admin(message.from_user.id):
        await message.answer(f"{tg_emoji(STICKERS['keys_count'], '⛔')} Доступ запрещен")
        return
...
async def admin_add_product(callback: CallbackQuery, state: FSMContext):
    if not is_admin(callback.from_user.id):
        await callback.answer(f"{tg_emoji(STICKERS['keys_count'], '⛔')}")
        return
    await state.set_state(AddProductStates.waiting_name)
    await callback.message.edit_text(f"{tg_emoji(BUTTON_EMOJI['add_product'], '📝')} Введите название товара:", parse_mode="HTML", reply_markup=InlineKeyboardMarkup(inline_keyboard=[[InlineKeyboardButton(text=f"{tg_emoji(BUTTON_EMOJI['back'], '❌')} Отмена", callback_data="admin_back", icon_custom_emoji_id=BUTTON_EMOJI["back"])]]))
    await callback.answer()
...
async def product_name(message: Message, state: FSMContext):
    ...
    await message.answer(f"{tg_emoji(BUTTON_EMOJI['add_balance'], '💰')} Введите цену (число):", parse_mode="HTML")
...
async def product_price(message: Message, state: FSMContext):
    ...
    try:
        ...
        await message.answer(f"{tg_emoji(BUTTON_EMOJI['add_keys'], '🔑')} Введите ключи (каждый с новой строки):\n\nПример:\n<code>KEY-123-ABC</code>\n<code>KEY-456-DEF</code>", parse_mode="HTML")
    except ValueError:
        await message.answer(f"{tg_emoji(STICKERS['keys_count'], '❌')} Введите число", parse_mode="HTML")
...
async def product_keys(message: Message, state: FSMContext):
    ...
    if not keys:
        await message.answer(f"{tg_emoji(STICKERS['keys_count'], '❌')} Хотя бы один ключ", parse_mode="HTML")
        return
    product_id = await add_product(data["name"], data["price"])
    await add_keys_to_product(product_id, keys)
    await message.answer(f"{tg_emoji(STICKERS['product_selected'], '✅')} Товар добавлен! {len(keys)} ключей\n📦 ID товара: {product_id}", parse_mode="HTML", reply_markup=get_admin_keyboard())
    await state.clear()
...
async def admin_add_keys(callback: CallbackQuery, state: FSMContext):
    ...
    products = await get_all_products()
    if not products:
        await callback.message.edit_text(f"{tg_emoji(STICKERS['keys_count'], '❌')} Сначала добавьте товар", parse_mode="HTML", reply_markup=get_admin_keyboard())
        await callback.answer()
        return
    kb = InlineKeyboardMarkup(inline_keyboard=[
        [InlineKeyboardButton(text=f"{p['name']} (ID: {p['id']})", callback_data=f"addkeys_{p['id']}")]
        for p in products
    ] + [[InlineKeyboardButton(text=f"{tg_emoji(BUTTON_EMOJI['back'], '◀️')} Назад", callback_data="admin_back", icon_custom_emoji_id=BUTTON_EMOJI["back"])]])
    await callback.message.edit_text(f"{tg_emoji(BUTTON_EMOJI['add_keys'], '📦')} Выберите товар для добавления ключей:", parse_mode="HTML", reply_markup=kb)
    await callback.answer()
...
async def select_for_keys(callback: CallbackQuery, state: FSMContext):
    ...
    await callback.message.edit_text(f"{tg_emoji(BUTTON_EMOJI['add_keys'], '🔑')} Введите ключи (по одному на строку):", parse_mode="HTML", reply_markup=InlineKeyboardMarkup(inline_keyboard=[[InlineKeyboardButton(text=f"{tg_emoji(BUTTON_EMOJI['back'], '❌')} Отмена", callback_data="admin_back", icon_custom_emoji_id=BUTTON_EMOJI["back"])]]))
    await callback.answer()
...
async def process_keys_only(message: Message, state: FSMContext):
    ...
    keys = [k.strip() for k in message.text.split("\n") if k.strip()]
    await add_keys_to_product(product_id, keys)
    await message.answer(f"{tg_emoji(STICKERS['product_selected'], '✅')} Добавлено {len(keys)} ключей для товара ID {product_id}", parse_mode="HTML", reply_markup=get_admin_keyboard())
    await state.clear()
...
async def admin_manage_products(callback: CallbackQuery):
    ...
    products = await get_all_products()
    if not products:
        await callback.message.edit_text(f"{tg_emoji(STICKERS['keys_count'], '📭')} <b>Список товаров пуст</b>", parse_mode="HTML", reply_markup=InlineKeyboardMarkup(inline_keyboard=[[InlineKeyboardButton(text=f"{tg_emoji(BUTTON_EMOJI['back'], '◀️')} Назад", callback_data="admin_back", icon_custom_emoji_id=BUTTON_EMOJI["back"])]]))
        await callback.answer()
        return
    text = f"{tg_emoji(BUTTON_EMOJI['delete_product'], '📦')} <b>Список товаров</b>\n\n"
    for p in products:
        text += f"🆔 ID: {p['id']}\n📛 Название: {p['name']}\n💰 Цена: {p['price']} ₽\n🗑️ /delproduct_{p['id']} - удалить товар\n\n"
    await callback.message.edit_text(text, parse_mode="HTML", reply_markup=InlineKeyboardMarkup(inline_keyboard=[[InlineKeyboardButton(text=f"{tg_emoji(BUTTON_EMOJI['back'], '◀️')} Назад", callback_data="admin_back", icon_custom_emoji_id=BUTTON_EMOJI["back"])]]))
    await callback.answer()
...
async def delete_product_cmd(message: Message):
    ...
    try:
        ...
        await message.answer(f"{tg_emoji(STICKERS['product_selected'], '✅')} Товар удален!", parse_mode="HTML", reply_markup=get_admin_keyboard())
    except:
        await message.answer(f"{tg_emoji(STICKERS['keys_count'], '❌')} Ошибка при удалении", parse_mode="HTML")
...
async def admin_manage_keys(callback: CallbackQuery):
    ...
    products = await get_all_products()
    if not products:
        await callback.message.edit_text(f"{tg_emoji(STICKERS['keys_count'], '📭')} <b>Сначала добавьте товар</b>", parse_mode="HTML", reply_markup=InlineKeyboardMarkup(inline_keyboard=[[InlineKeyboardButton(text=f"{tg_emoji(BUTTON_EMOJI['back'], '◀️')} Назад", callback_data="admin_back", icon_custom_emoji_id=BUTTON_EMOJI["back"])]]))
        await callback.answer()
        return
    kb = InlineKeyboardMarkup(inline_keyboard=[
    ...
    await callback.message.edit_text(f"{tg_emoji(BUTTON_EMOJI['delete_key'], '🔑')} Выберите товар для просмотра ключей:", parse_mode="HTML", reply_markup=kb)
    await callback.answer()
...
async def show_keys(callback: CallbackQuery):
    ...
    if not keys:
        await callback.message.edit_text(f"{tg_emoji(BUTTON_EMOJI['delete_key'], '🔑')} <b>Ключи для товара {product['name']}</b>\n\nСписок пуст", parse_mode="HTML", reply_markup=InlineKeyboardMarkup(inline_keyboard=[[InlineKeyboardButton(text=f"{tg_emoji(BUTTON_EMOJI['back'], '◀️')} Назад", callback_data="admin_manage_keys", icon_custom_emoji_id=BUTTON_EMOJI["back"])]]))
        await callback.answer()
        return
    text = f"{tg_emoji(BUTTON_EMOJI['delete_key'], '🔑')} <b>Ключи для товара {product['name']}</b>\n\n"
    for k in keys:
        status = "✅ Использован" if k["used"] else "🟢 Доступен"
        text += f"🆔 ID: {k['id']} | {k['key_value']} | {status}\n🗑️ /delkey_{k['id']} - удалить ключ\n\n"
    await callback.message.edit_text(text, parse_mode="HTML", reply_markup=InlineKeyboardMarkup(inline_keyboard=[[InlineKeyboardButton(text=f"{tg_emoji(BUTTON_EMOJI['back'], '◀️')} Назад", callback_data="admin_manage_keys", icon_custom_emoji_id=BUTTON_EMOJI["back"])]]))
    await callback.answer()
...
async def delete_key_cmd(message: Message):
    ...
    try:
        ...
        await message.answer(f"{tg_emoji(STICKERS['product_selected'], '✅')} Ключ удален!", parse_mode="HTML", reply_markup=get_admin_keyboard())
    except:
        await message.answer(f"{tg_emoji(STICKERS['keys_count'], '❌')} Ошибка при удалении", parse_mode="HTML")
...
async def admin_add_balance(callback: CallbackQuery, state: FSMContext):
    ...
    await callback.message.edit_text(f"{tg_emoji(BUTTON_EMOJI['add_balance'], '💰')} <b>Выдача баланса пользователю</b>\n\nВведите ID пользователя Telegram:\n\nПример: <code>123456789</code>", parse_mode="HTML", reply_markup=InlineKeyboardMarkup(inline_keyboard=[[InlineKeyboardButton(text=f"{tg_emoji(BUTTON_EMOJI['back'], '❌')} Отмена", callback_data="admin_back", icon_custom_emoji_id=BUTTON_EMOJI["back"])]]))
    await callback.answer()
...
async def process_add_balance_user_id(message: Message, state: FSMContext):
    ...
    try:
        ...
        await message.answer(f"{tg_emoji(BUTTON_EMOJI['add_balance'], '💰')} Введите сумму для начисления на баланс:\n\nПример: <code>500</code>", parse_mode="HTML")
    except ValueError:
        await message.answer(f"{tg_emoji(STICKERS['keys_count'], '❌')} Неверный ID. Введите число.", parse_mode="HTML")
...
async def admin_broadcast(callback: CallbackQuery, state: FSMContext):
    ...
    await callback.message.edit_text(f"{tg_emoji(BUTTON_EMOJI['broadcast'], '📢')} <b>Рассылка сообщения</b>\n\nВведите текст сообщения для рассылки всем пользователям:\n\nПоддерживается HTML разметка", parse_mode="HTML", reply_markup=InlineKeyboardMarkup(inline_keyboard=[[InlineKeyboardButton(text=f"{tg_emoji(BUTTON_EMOJI['back'], '❌')} Отмена", callback_data="admin_back", icon_custom_emoji_id=BUTTON_EMOJI["back"])]]))
    await callback.answer()
...
async def process_broadcast(message: Message, state: FSMContext):
    ...
    await message.answer(f"{tg_emoji(BUTTON_EMOJI['broadcast'], '📢')} <b>Начинаю рассылку...</b>\n\n👥 Всего пользователей: <code>{len(users)}</code>", parse_mode="HTML")
    success_count = 0
    fail_count = 0
    for user in users:
        try:
...
async def admin_create_promocode(callback: CallbackQuery, state: FSMContext):
    ...
    await callback.message.edit_text(f"{tg_emoji(BUTTON_EMOJI['promocode'], '🎫')} <b>Создание промокода</b>\n\nВведите название промокода (только латиница и цифры, без пробелов):\n\nПример: <code>SUMMER2024</code>", parse_mode="HTML", reply_markup=InlineKeyboardMarkup(inline_keyboard=[[InlineKeyboardButton(text=f"{tg_emoji(BUTTON_EMOJI['back'], '❌')} Отмена", callback_data="admin_back", icon_custom_emoji_id=BUTTON_EMOJI["back"])]]))
    await callback.answer()
...
async def create_promocode_code(message: Message, state: FSMContext):
    ...
    kb = InlineKeyboardMarkup(inline_keyboard=[
        [InlineKeyboardButton(text=f"{tg_emoji(BUTTON_EMOJI['promocode'], '%')} Скидка в процентах (%)", callback_data="promo_type_percent")],
        [InlineKeyboardButton(text=f"{tg_emoji(BUTTON_EMOJI['promocode'], '💰')} Скидка в рублях (₽)", callback_data="promo_type_rubles")],
        [InlineKeyboardButton(text=f"{tg_emoji(BUTTON_EMOJI['promocode'], '🎁')} Бонусный баланс (₽)", callback_data="promo_type_bonus")],
        [InlineKeyboardButton(text=f"{tg_emoji(BUTTON_EMOJI['back'], '❌')} Отмена", callback_data="admin_back", icon_custom_emoji_id=BUTTON_EMOJI["back"])]
    ])
    await message.answer(f"{tg_emoji(BUTTON_EMOJI['promocode'], '📊')} <b>Выберите тип промокода:</b>", parse_mode="HTML", reply_markup=kb)
...
async def create_promocode_type(callback: CallbackQuery, state: FSMContext):
    ...
    if discount_type == "percent":
        await callback.message.edit_text(f"{tg_emoji(BUTTON_EMOJI['promocode'], '📊')} Введите размер скидки в процентах (число от 1 до 100):\n\nПример: <code>10</code>", parse_mode="HTML")
    else:
        await callback.message.edit_text(f"{tg_emoji(BUTTON_EMOJI['promocode'], '💰')} Введите сумму скидки или бонуса в рублях (число):\n\nПример: <code>500</code>", parse_mode="HTML")
    await callback.answer()
...
async def create_promocode_value(message: Message, state: FSMContext):
    ...
    try:
        ...
        if value <= 0:
            await message.answer(f"{tg_emoji(STICKERS['keys_count'], '❌')} Значение должно быть больше 0", parse_mode="HTML")
            return
        await state.update_data(discount_value=value)
        await state.set_state(AdminCreatePromocodeStates.waiting_max_uses)
        await message.answer(f"{tg_emoji(BUTTON_EMOJI['promocode'], '🔢')} Введите максимальное количество активаций промокода:\n\nПример: <code>100</code>", parse_mode="HTML")
    except ValueError:
        await message.answer(f"{tg_emoji(STICKERS['keys_count'], '❌')} Введите число", parse_mode="HTML")
...
async def create_promocode_max_uses(message: Message, state: FSMContext):
    ...
    try:
        ...
        if max_uses <= 0:
            await message.answer(f"{tg_emoji(STICKERS['keys_count'], '❌')} Количество активаций должно быть больше 0", parse_mode="HTML")
            return
        data = await state.get_data()
        code = data["code"]
        ...
        await message.answer(f"{tg_emoji(STICKERS['product_selected'], '✅')} <b>Промокод успешно создан!</b>\n\n🎫 Код: <code>{code}</code>\n📊 Тип: {type_text}\n🔢 Максимум активаций: <code>{max_uses}</code>", parse_mode="HTML", reply_markup=get_admin_keyboard())
        await state.clear()
    except ValueError:
        await message.answer(f"{tg_emoji(STICKERS['keys_count'], '❌')} Введите число", parse_mode="HTML")
...
async def admin_list_promocodes(callback: CallbackQuery):
    ...
    if not promocodes:
        await callback.message.edit_text(f"{tg_emoji(STICKERS['keys_count'], '📭')} <b>Список промокодов пуст</b>", parse_mode="HTML", reply_markup=get_admin_keyboard())
        await callback.answer()
        return
    text = f"{tg_emoji(BUTTON_EMOJI['promocode'], '🎫')} <b>Список промокодов</b>\n\n"
    for p in promocodes:
...
async def delete_promocode_cmd(message: Message):
    ...
    try:
        ...
        await message.answer(f"{tg_emoji(STICKERS['product_selected'], '✅')} Промокод удален!", parse_mode="HTML", reply_markup=get_admin_keyboard())
    except:
        await message.answer(f"{tg_emoji(STICKERS['keys_count'], '❌')} Ошибка при удалении", parse_mode="HTML")
...
async def admin_ref_config(callback: CallbackQuery, state: FSMContext):
    ...
    kb = InlineKeyboardMarkup(inline_keyboard=[
        [InlineKeyboardButton(text=f"{tg_emoji(BUTTON_EMOJI['referral'], '💰')} Фиксированная сумма (₽)", callback_data="ref_type_rubles")],
        [InlineKeyboardButton(text=f"{tg_emoji(BUTTON_EMOJI['referral'], '%')} Процент от покупки (%)", callback_data="ref_type_percent")],
        [InlineKeyboardButton(text=f"{tg_emoji(BUTTON_EMOJI['back'], '❌')} Отмена", callback_data="admin_back", icon_custom_emoji_id=BUTTON_EMOJI["back"])]
    ])
    await callback.message.edit_text(f"{tg_emoji(BUTTON_EMOJI['referral'], '🎁')} <b>Настройка реферального бонуса</b>\n\nВыберите тип бонуса за первую покупку приглашённого друга:", parse_mode="HTML", reply_markup=kb)
    await callback.answer()
...
async def ref_type_callback(callback: CallbackQuery, state: FSMContext):
    ...
    if bonus_type == "rubles":
        await callback.message.edit_text(f"{tg_emoji(BUTTON_EMOJI['referral'], '💰')} Введите фиксированную сумму бонуса в рублях:\n\nПример: <code>50</code>", parse_mode="HTML")
    else:
        await callback.message.edit_text(f"{tg_emoji(BUTTON_EMOJI['referral'], '%')} Введите процент от покупки (число от 1 до 100):\n\nПример: <code>10</code>", parse_mode="HTML")
    await callback.answer()
...
async def ref_value_callback(message: Message, state: FSMContext):
    ...
    try:
        ...
        await message.answer(f"{tg_emoji(STICKERS['product_selected'], '✅')} <b>Настройки реферальной системы обновлены!</b>\n\n🎁 Тип бонуса: {bonus_text}", parse_mode="HTML", reply_markup=get_admin_keyboard())
        await state.clear()
    except ValueError:
        await message.answer(f"{tg_emoji(STICKERS['keys_count'], '❌')} Введите число", parse_mode="HTML")
...
async def admin_crypto_settings(callback: CallbackQuery, state: FSMContext):
    ...
    text = f"{tg_emoji(BUTTON_EMOJI['crypto'], '💎')} <b>Настройки криптооплаты</b>\n\n📊 Режим: <code>{'Автоматический' if mode == 'auto' else 'Ручной'}</code>\n💰 Валюта: <code>{currency}</code>\n💲 Сумма: <code>{amount}</code>\n📝 Текст ручного режима: <code>{manual_text[:50]}...</code>\n🖼 Фото: <code>{manual_photo}</code>\n\nВыберите действие:"
    kb = InlineKeyboardMarkup(inline_keyboard=[
        [InlineKeyboardButton(text=f"{tg_emoji(BUTTON_EMOJI['crypto'], '🔄')} Переключить режим (авто/ручной)", callback_data="crypto_toggle_mode")],
        [InlineKeyboardButton(text=f"{tg_emoji(BUTTON_EMOJI['crypto'], '💰')} Настроить валюту и сумму", callback_data="crypto_set_currency")],
        [InlineKeyboardButton(text=f"{tg_emoji(BUTTON_EMOJI['crypto'], '📝')} Настроить текст ручного режима", callback_data="crypto_set_manual_text")],
        [InlineKeyboardButton(text=f"{tg_emoji(BUTTON_EMOJI['crypto'], '🖼')} Настроить фото для ручного режима", callback_data="crypto_set_manual_photo")],
        [InlineKeyboardButton(text=f"{tg_emoji(BUTTON_EMOJI['back'], '◀️')} Назад", callback_data="admin_back", icon_custom_emoji_id=BUTTON_EMOJI["back"])]
    ])
    await callback.message.edit_text(text, parse_mode="HTML", reply_markup=kb)
    await callback.answer()
...
async def crypto_toggle_mode(callback: CallbackQuery):
    ...
    await callback.answer(f"{tg_emoji(STICKERS['product_selected'], '✅')} Режим изменён на {'автоматический' if new_mode == 'auto' else 'ручной'}")
...
async def crypto_set_currency(callback: CallbackQuery, state: FSMContext):
    ...
    await callback.message.edit_text(f"{tg_emoji(BUTTON_EMOJI['crypto'], '💰')} Введите валюту (USDT, BTC, ETH):\n\nПример: <code>USDT</code>", parse_mode="HTML", reply_markup=InlineKeyboardMarkup(inline_keyboard=[[InlineKeyboardButton(text=f"{tg_emoji(BUTTON_EMOJI['back'], '❌')} Отмена", callback_data="admin_crypto_settings", icon_custom_emoji_id=BUTTON_EMOJI["back"])]]))
    await callback.answer()
...
async def crypto_set_currency_value(message: Message, state: FSMContext):
    ...
    await message.answer(f"{tg_emoji(BUTTON_EMOJI['crypto'], '💰')} Введите сумму в {currency}:\n\nПример: <code>10</code>", parse_mode="HTML")
...
async def crypto_set_amount_value(message: Message, state: FSMContext):
    ...
    try:
        ...
        await state.clear()
        await message.answer(f"{tg_emoji(STICKERS['product_selected'], '✅')} Настройки криптооплаты обновлены!\n\n💰 Валюта: {currency}\n💲 Сумма: {amount}", parse_mode="HTML", reply_markup=get_admin_keyboard())
    except ValueError:
        await message.answer(f"{tg_emoji(STICKERS['keys_count'], '❌')} Введите число", parse_mode="HTML")
...
async def crypto_set_manual_text(callback: CallbackQuery, state: FSMContext):
    ...
    await callback.message.edit_text(f"{tg_emoji(BUTTON_EMOJI['crypto'], '📝')} Введите текст для ручного режима оплаты криптовалютой:\n\nПример:\n<code>Для оплаты переведите USDT TRC20 на кошелек: TXXXX...\nПосле оплаты отправьте скриншот и хэш администратору.</code>", parse_mode="HTML", reply_markup=InlineKeyboardMarkup(inline_keyboard=[[InlineKeyboardButton(text=f"{tg_emoji(BUTTON_EMOJI['back'], '❌')} Отмена", callback_data="admin_crypto_settings", icon_custom_emoji_id=BUTTON_EMOJI["back"])]]))
    await callback.answer()
...
async def crypto_set_manual_text_value(message: Message, state: FSMContext):
    ...
    await state.clear()
    await message.answer(f"{tg_emoji(STICKERS['product_selected'], '✅')} Текст ручного режима обновлён!", parse_mode="HTML", reply_markup=get_admin_keyboard())
...
async def crypto_set_manual_photo(callback: CallbackQuery, state: FSMContext):
    ...
    await callback.message.edit_text(
        f"{tg_emoji(BUTTON_EMOJI['crypto'], '🖼')} Отправьте фото для ручного режима оплаты.\n\n"
        f"Просто отправьте фото в этот чат (как обычное сообщение).\n"
        f"Нажмите /skip чтобы пропустить.",
        parse_mode="HTML",
        reply_markup=InlineKeyboardMarkup(inline_keyboard=[[InlineKeyboardButton(text=f"{tg_emoji(BUTTON_EMOJI['back'], '◀️')} Назад", callback_data="admin_crypto_settings", icon_custom_emoji_id=BUTTON_EMOJI["back"])]])
    )
    await callback.answer()
...
async def crypto_set_manual_photo_value(message: Message, state: FSMContext):
    ...
    if message.photo:
        ...
        await message.answer(f"{tg_emoji(STICKERS['product_selected'], '✅')} Фото получено!")
    crypto_config = await get_crypto_config()
    ...
    await state.clear()
    await message.answer(f"{tg_emoji(STICKERS['product_selected'], '✅')} Фото для ручного режима обновлено!", parse_mode="HTML", reply_markup=get_admin_keyboard())
...
async def admin_edit_messages(callback: CallbackQuery, state: FSMContext):
    ...
    text = f"{tg_emoji(BUTTON_EMOJI['edit'], '✏️')} <b>Редактирование сообщений бота</b>\n\nВыберите сообщение для редактирования:\n\n"
    kb = []
    for msg in messages:
        key = msg["message_key"]
        text += f"• <code>{key}</code>\n"
        kb.append([InlineKeyboardButton(text=f"{tg_emoji(BUTTON_EMOJI['edit'], '📝')} {key}", callback_data=f"edit_msg_{key}")])
    kb.append([InlineKeyboardButton(text=f"{tg_emoji(BUTTON_EMOJI['back'], '◀️')} Назад", callback_data="admin_back", icon_custom_emoji_id=BUTTON_EMOJI["back"])])
...
async def edit_message_select(callback: CallbackQuery, state: FSMContext):
    ...
    await callback.message.edit_text(
        f"{tg_emoji(BUTTON_EMOJI['edit'], '✏️')} <b>Редактирование сообщения: {message_key}</b>\n\n"
        ...
        parse_mode="HTML",
        reply_markup=InlineKeyboardMarkup(inline_keyboard=[[InlineKeyboardButton(text=f"{tg_emoji(BUTTON_EMOJI['back'], '◀️')} Назад", callback_data="admin_edit_messages", icon_custom_emoji_id=BUTTON_EMOJI["back"])]])
    )
    await callback.answer()
...
async def edit_message_text(message: Message, state: FSMContext):
    ...
    await message.answer(
        f"{tg_emoji(STICKERS['product_selected'], '✅')} Текст сохранён!\n\n"
...
async def skip_photo(message: Message, state: FSMContext):
    ...
    await message.answer(
        f"{tg_emoji(STICKERS['product_selected'], '✅')} <b>Сообщение обновлено!</b>\n\n"
...
async def admin_stats(callback: CallbackQuery):
    ...
    await callback.message.edit_text(
        f"{tg_emoji(BUTTON_EMOJI['stats'], '📊')} <b>Статистика</b>\n\n"
    ...
    if status == "success" and order_id:
        ...
        if user_id:
            async def update_balance():
                ...
                await bot.send_message(user_id, f"{tg_emoji(STICKERS['product_selected'], '✅')} <b>Баланс пополнен!</b>\n\nСумма: <code>{amount} ₽</code>\nНовый баланс: <code>{current + amount} ₽</code>", parse_mode="HTML")
...
async def main():
    ...
    thread.start()
    print(f"{tg_emoji(STICKERS['magic'], '🤖')} Бот запущен")
